...
class Signatory(object):
    ...
    def upload_signature_image(self, image_filename, signatory_number):
        """
        Opens upload image dialog and upload given image file.
        """
        self.wait_for_signature_image_upload_button(signatory_number)
        self.find_css('.action-upload-signature').first.click()
        self.find_css('.action-upload-signature').first.click()
        self.wait_for_signature_image_upload_prompt(signatory_number)
